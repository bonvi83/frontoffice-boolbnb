        ...
        <div class="container">
          <div class="row">
            <div class="col-12">
              ...
              <div>
                <!-- Bottone Modale -->
                <button type="button" class="mt-1 btn btn-success" data-bs-toggle="modal" data-bs-target="#messageModal">
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h2 class="modal-title fs-5" id="messageModalLabel">Manda un messaggio al proprietario</h2>
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="button" @click="sendMessages()" :data-bs-dismiss="shouldCloseModal ? 'modal' : ''" class="btn btn-primary">Invia</button>
                    </div>
                  </div>
                </div>
              </div>
